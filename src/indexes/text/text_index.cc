...
std::function<void*(void*)> CreateTargetSetFn(InvasivePtr<Postings>& updated_target) {
  return [&updated_target](void* old_val) -> void* {
    ...
    // Grab a new reference to the new shared postings object and pass ownership of
    // it to the tree.
